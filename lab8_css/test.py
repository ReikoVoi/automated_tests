...
class Kalkpro(unittest.TestCase):
    ...
    def test_calc(self):
        ...
        elem = driver.find_element_by_css_selector(".spr--calculator")
        elem.click()
    ...
    def test_calc_sum(self):
        ...
        # перебиваем цифры от 4 до 6 (ноль не будет отображаться перед 1)
        for i in range(4, 7):
            print("Нажатие кнопки ", str(i), ": ")
            elem = driver.find_element_by_name(str(i))
            elem.click()
    ...
    def test_calc_sub(self):
        ...
        # (ноль не будет отображаться перед 1)
        elem = driver.find_element_by_class_name("display-indicator-ceils")
        self.assertEqual(elem.text, str(456 - 123))
    ...
    def test_calc_div(self):
        ...
        # ждем, пока калькулятор откроется
        time.sleep(5)
        # перебиваем цифры от 4 до 5 (ноль не будет отображаться перед 1)
        for i in range(4, 6):
            print("Нажатие кнопки ", str(i), ": ")
            elem = driver.find_element_by_name(str(i))
            elem.click()
        ...
        # (ноль не будет отображаться перед 1)
        elem = driver.find_element_by_class_name("display-indicator-ceils")
        self.assertEqual(elem.text, str(45 / 12))
